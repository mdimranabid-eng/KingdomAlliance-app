...
function loadEnv() {
  ...
  if (!loaded) {
    console.warn('⚠️ No env files (.env, .env.development, .env.production) found at project root.');
  }
}
...
(async () => {
  try {
    ...
    console.log(`✉️ Sending test email to md.imranabid@gmail.com...`);
    const info = await transporter.sendMail({
      from: `"Kingdom Alliance Test" <${SMTP_USER}>`,
      to: 'md.imranabid@gmail.com',
